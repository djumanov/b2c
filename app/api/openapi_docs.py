...
TAGS: Final[list[dict[str, Any]]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "the order costs today and hands its answer through as is. "
            "Unchanged, that is the whole step — GTS refuses to confirm a "
            "price that did not move, so the payment screen follows "
            "straight away. Changed, `POST …/reprice/confirm/` is the "
