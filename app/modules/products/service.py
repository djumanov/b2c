...
**Every step here is stateless** — no offer, no search state, nowhere; the
regression tests hold them to D2. Booking, which was the one exception,
belonged to the order system and went with it.
