...
site's company contacts, leads support contact, the order status messages
customers see while paying and ticketing, and every
...
settings and order messages by still being at their untouched
