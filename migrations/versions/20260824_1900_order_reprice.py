...
and GTS confirmed it (``price_confirmed_at``). Both NULL for every existing
row: an order booked before this release goes through the price steps like
a new one before it can be paid.
"""
